...
class StubMessageRepository : IMessageRepository
{
    private val messages: ArrayList<Message> = arrayListOf(
        Message(1, 1, "Sed egestas dapibus nibh a", Date(2023, 11, 12, 18, 27, 15)),
        Message(
            1,
            2,
        ...
        Message(1, 1, "vestibulum interdum tempus magna)", Date(2023, 11, 12, 18, 29, 15)),
        Message(1, 1, "Integer molestie", Date(2023, 11, 12, 18, 29, 47)),
        Message(1, 2, "Suspendisse potenti. Duis sed libero nec", Date(2023, 11, 12, 18, 30, 15)),
        Message(1, 2, "Phasellus tincidunt?", Date(2023, 11, 12, 18, 30, 19)),
        Message(1, 1, "Donec lectus lorem, imperdiet nec laoreet eu?", Date(2023, 11, 12, 18, 31, 15)),
        Message(1, 2, "Curabitur venenatis, nisl!", Date(2023, 11, 12, 18, 31, 41))
    )
